...
def PlotL(Date,sc,ut=[0.0,24.0],fig=None,maps=[1,1,0,0],nox=False):
	...
	ax.plot(data.utc,data.Lshell,color='blue')
	...
	ax.hlines(np.arange(2,8),utc0,utc1,color=[0.0,0.0,0.0,0.25],linestyle=':')
